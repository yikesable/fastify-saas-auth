 ...
 * @property {import('openid-client').UserinfoResponse} userinfo
 */
 ...
 * @param {string} authId
 * @param {import('openid-client').UserinfoResponse} issuerUserinfo
...
const fastifySaasAuthPluginFactory = async (fastify, options) => {
  ...
  fastify.register(import('./fastify-user.js'), { getUserIdFromHeader, loadUser });
