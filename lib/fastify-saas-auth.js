 ...
 * @param {string} authId
 * @param {import('./advanced-types.d.ts').SaasAuthIssuerUserInfo} issuerUserinfo
 ...
 * @property {{ [name: string]: import('./advanced-types.d.ts').AnySaasAuthIssuer }} authIssuers
...
const fastifySaasAuthPluginFactory = async (fastify, options) => {
  ...
  /** @type {import('./advanced-types.d.ts').SaasAuthIssuerPluginCallback} */
